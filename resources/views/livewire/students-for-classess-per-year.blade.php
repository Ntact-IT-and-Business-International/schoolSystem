...
<div>
    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
        @foreach($students_for_particular_for_year as $i=>$student)
            <tr>
    ...
    <div class="row">
        <div class="col-sm-6 mb-2">
            Showing {{$students_for_particular_for_year->firstItem()}} to {{$students_for_particular_for_year->lastItem()}} out of {{$students_for_particular_for_year->total()}} items
        </div>
        <div class="text-right col-sm-6 mb-2">
            {{$students_for_particular_for_year->links()}}
        </div>
    </div>
