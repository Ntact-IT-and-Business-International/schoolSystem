<nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-dark container-p-x" id="layout-navbar" style="background-color:#FF4961">

            <!-- Brand demo (see assets/css/demo/demo.css) -->
            <a href="/dashboard" class="navbar-brand app-brand demo d-lg-none py-0 mr-4">
                <span class="app-brand-logo demo">
                    {{--<img src="{{ asset('Admin/assets/img/logo-dark.png')}}" alt="Brand Logo" class="img-fluid">--}}
                </span>
                <span class="app-brand-text demo font-weight-normal ml-2">Mukono</span>
            </a>
                    ...
                    <div class="demo-navbar-user nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                            <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                                <img src="{{asset('storage/user_photos/'.auth()->user()->getLoggedInUserLogo())}}" style="border-radius:50%;height:40px; width:40px;" alt class="d-block  rounded-circle">
