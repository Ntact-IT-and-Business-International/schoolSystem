...
<div class="invoice-print p-5">
                <div class="row">
                    <div class="col-sm-12 pb-4 text-center">
                        <div class="media align-items-center text-center" style="margin-bottom:1px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-4 text-right">
                        <div class="font-weight-bold mb-2">School Fees Balance:<span style="border-bottom:1px dotted;"> &nbsp;{{ number_format($detail->balance)}}</span></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 mb-4">
